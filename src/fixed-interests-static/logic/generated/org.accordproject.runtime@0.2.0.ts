...
} from './org.accordproject.fixedinterestsstatic@0.1.0';
...
export type RequestUnion = IFixedInterestsStaticRequest;

export interface IResponse extends ITransaction {
}

export type ResponseUnion = IFixedInterestsStaticResponse;
