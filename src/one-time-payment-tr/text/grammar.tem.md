TEK SEFERLİK ÖDEME HİZMETİ SÖZLEŞMESİ
...
7. Upon the signing of this Agreement, {{buyer}} shall pay the total purchase price to {{seller}} in the amount of {{totalPurchasePrice}} {{currencyCode}}.