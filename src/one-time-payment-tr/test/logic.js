...
describe('Logic', () => {
    ...
    describe('#OneTimePaymentTr', async function() {

        it('should produce correct payment in TRY', async function() {
            const request = {};
            request.$class = 'org.accordtr.onetimepayment.InitRequest';
            ...
            result.emit[0].amount.currencyCode.should.equal("TRY");
            state = result.state;
