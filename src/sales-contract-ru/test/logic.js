...
describe('Logic', () => {
    ...
    describe('#SalesContractRu', async function() {

        it('should say whether contract is valid', async function() {
            const request = {};
            request.$class = 'org.accordru.salescontract.MyRequest';
            request.input = 'Contract Valid';
            const state = {};
            ...
            result.response.output.should.equal('Contract Valid');
        });
    });
});
