...
describe('Logic', () => {
    ...
    describe('#RequestPayment', async function() {
        ...
        it('lease cost should be payed to the amount of', async function() {
            const request = {};
            request.$class = 'com.accordtr.carrental.PaymentRequest';
            const state = {};
            ...
            result.response.amount.doubleValue.should.equal(217.0);
        });
    });
});