...
import { ITemplateModel, IPaymentRequest, IPaymentClause } from './generated/org.accordproject.copyrightlicense@0.3.0';
...
describe('CopyrightLicenseLogic', () => {
    ...
    beforeEach(() => {
        ...
        const paymentClause: IPaymentClause = {
            $class: 'org.accordproject.copyrightlicense@0.3.0.PaymentClause',
        ...
        model = {
            $class: 'org.accordproject.copyrightlicense@0.3.0.TemplateModel',
    ...
    describe('trigger', () => {
        it('should return the payment amount and emit a payment obligation event', async () => {
            const request: IPaymentRequest = {
                $class: 'org.accordproject.copyrightlicense@0.3.0.PaymentRequest',
                $timestamp: new Date()
            };
            ...
            expect(result.result.$class).toBe('org.accordproject.copyrightlicense@0.3.0.PayOut');
        ...
        it('should emit a PaymentObligationEvent with correct description', async () => {
            ...
            expect(event.$class).toBe('org.accordproject.copyrightlicense@0.3.0.PaymentObligationEvent');
