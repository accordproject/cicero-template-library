...
Payment. As consideration in full for the rights granted herein, Licensee shall pay Licensor a one-time fee in the amount of {{amountText}} ({{amount}} {{currencyCode}}) upon execution of this Agreement, payable as follows: {{paymentProcedure}}.
{{/clause}}
