...
describe('SupplyAgreementLocLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.supplyagreementloc@0.2.0.TemplateModel',
    ...
    describe('trigger - sensorReading', () => {
        it('should append sensor reading to state', async () => {
            const reading: ISensorReading = {
                $class: 'org.accordproject.supplyagreementloc@0.2.0.SensorReading',
            ...
            expect(result.result.$class).toBe('org.accordproject.supplyagreementloc@0.2.0.DeliveryResponse');
    ...
    describe('trigger - checkContract', () => {
        it('should report in good order when sufficient readings are available', async () => {
            ...
            const checkRequest: ICheckContract = {
                $class: 'org.accordproject.supplyagreementloc@0.2.0.CheckContract',
                $identifier: 'check-1',
                $timestamp: new Date(),
            };
