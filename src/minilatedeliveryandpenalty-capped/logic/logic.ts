import { ITemplateModel, ILateRequest, ILateResponse } from './generated/org.accordproject.minilatedeliveryandpenaltycapped@0.3.0';
...
class MiniLateDeliveryAndPenaltyCappedLogic extends TemplateLogic<ITemplateModel> {
    async trigger(data: ITemplateModel, request: ILateRequest): Promise<MiniLateDeliveryCappedResponse> {
        ...
        return {
            result: {
                $class: 'org.accordproject.minilatedeliveryandpenaltycapped@0.3.0.LateResponse',
                $timestamp: new Date(),
