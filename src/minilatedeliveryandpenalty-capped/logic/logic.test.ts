...
import { ITemplateModel, ILateRequest } from './generated/org.accordproject.minilatedeliveryandpenaltycapped@0.3.0';
...
describe('MiniLateDeliveryAndPenaltyCappedLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.minilatedeliveryandpenaltycapped@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            buyer: 'Alice',
            seller: 'Bob',
    ...
    describe('trigger', () => {
        it('should calculate capped penalty', async () => {
            ...
            const request: ILateRequest = {
                $class: 'org.accordproject.minilatedeliveryandpenaltycapped@0.3.0.LateRequest',
                $timestamp: new Date(),
