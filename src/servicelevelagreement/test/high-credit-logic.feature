Feature: Service Level Agreement
  This describe the expected behavior for the Accord Project's Service Level Agreement
...
"""
  ...
  Scenario: The contract should give more credit for 97.0% availability with monthly cap
...
"""
  ...
  Scenario: The contract should give credit capped at annual cap
    When it receives the request
"""
{
    "$class": "org.accordproject.servicelevelagreement.MonthSummary",
...
"""
  ...
  Scenario: The contract should return the correct monthly credit
    When it receives the request
"""
{
    "$class": "org.accordproject.servicelevelagreement.MonthSummary",
...
"""
  ...
  Scenario: The contract should reject month summaries with negative service levels
    When it receives the request
"""
{
    "$class": "org.accordproject.servicelevelagreement.MonthSummary",
