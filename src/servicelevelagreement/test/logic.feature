...
"""
  ...
  Scenario: The contract should give no credit for 100% availability
...
"""
  ...
  Scenario: The contract should give some credit for 99.7% availability
    When it receives the request
"""
{
    "$class": "org.accordproject.servicelevelagreement.MonthSummary",
...
"""
  ...
  Scenario: The contract should give more credit for 97.0% availability
    When it receives the request
"""
{
    "$class": "org.accordproject.servicelevelagreement.MonthSummary",
