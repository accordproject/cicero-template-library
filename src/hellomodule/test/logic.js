...
describe('Logic', () => {
    ...
    describe('#HelloModule', async function() {

        it('should produce correct result', async function() {
            const request = {};
            request.$class = 'org.accordproject.hellomodule.MyRequest';
            ...
            result.response.output.should.equal('Hello Fred Blogs (Module) [motd: PI/2.0 radians is 90.0 degrees]');
        });
    });
});
