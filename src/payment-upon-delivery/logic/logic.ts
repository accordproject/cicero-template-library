...
} from './generated/org.accordproject.paymentupondelivery@0.3.0';
...
class PaymentUponDeliveryLogic extends TemplateLogic<ITemplateModel> {
    async trigger(data: ITemplateModel, request: IDeliveryAcceptedRequest): Promise<PaymentUponDeliveryResponse> {
        ...
        const event: IPaymentObligationEvent = {
            $class: 'org.accordproject.paymentupondelivery@0.3.0.PaymentObligationEvent',
            $timestamp: now,
            amount: totalAmount,
        ...
        return {
            result: {
                $class: 'org.accordproject.paymentupondelivery@0.3.0.DeliveryAcceptedResponse',
                $timestamp: now,
                totalAmount,
                currencyCode: data.currencyCode,
            },
