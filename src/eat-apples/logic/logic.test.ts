...
import { ITemplateModel, IFood } from './generated/org.accordproject.eatapples@0.3.0';
...
describe('EatApplesLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.eatapples@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            employee: 'John',
            company: 'Acme',
    ...
    describe('trigger', () => {
        it('should approve eating an apple and bill correctly', async () => {
            const request: IFood = {
                $class: 'org.accordproject.eatapples@0.3.0.Food',
                $timestamp: new Date(),
                produce: 'apple',
                price: 1.49,
            };
