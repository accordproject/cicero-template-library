...
"""
  ...
  Scenario: The delivery was received late (specified in seconds) with two mishandling breaches
    When it receives the request
"""
{
    "$class": "io.clause.demo.fragileGoods.DeliveryUpdate",
    "startTime": "2018-01-01T16:34:00.000Z",
    "finishTime": "2018-01-01T16:44:11.000Z",
    "status": "ARRIVED",
    "accelerometerReadings": [0.2,0.6,-0.3,-0.7,0.1]
}
"""
...
"""
  ...
  Scenario: The delivery was received in time (short duration) with two mishandling breaches
    When it receives the request
"""
{
    "$class": "io.clause.demo.fragileGoods.DeliveryUpdate",
...
"""
  ...
  Scenario: The delivery was received in time (short duration) with no breaches
    When it receives the request
"""
{
    "$class": "io.clause.demo.fragileGoods.DeliveryUpdate",
