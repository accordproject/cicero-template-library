...
import { ITemplateModel, ILateDeliveryAndPenaltyRequest } from './generated/org.accordproject.latedeliveryandpenaltyoptionalthis@0.3.0';
...
describe('LateDeliveryAndPenaltyOptionalThisLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.latedeliveryandpenaltyoptionalthis@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            buyer: 'Alice',
            seller: 'Bob',
    ...
    describe('trigger', () => {
        it('should return penalty=0 and buyerMayTerminate=true when both contract and request have force majeure set', async () => {
            const request: ILateDeliveryAndPenaltyRequest = {
                $class: 'org.accordproject.latedeliveryandpenaltyoptionalthis@0.3.0.LateDeliveryAndPenaltyRequest',
                $timestamp: new Date(),
                forceMajeure: 99.0,
        ...
        it('should emit a PaymentObligationEvent with correct fields', async () => {
            ...
            expect(event.$class).toBe('org.accordproject.latedeliveryandpenaltyoptionalthis@0.3.0.PaymentObligationEvent');
