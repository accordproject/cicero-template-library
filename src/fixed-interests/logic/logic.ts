import { ITemplateModel, IFixedInterestsRequest, IFixedInterestsResponse } from "./generated/org.accordproject.fixedinterests@0.3.0";
    ...
    async trigger(data: ITemplateModel, request: IFixedInterestsRequest): Promise<FixedInterestsResponse> {
        ...
        return {
            result: {
                ...
                $timestamp: new Date(),
                $class: 'org.accordproject.fixedinterests@0.3.0.FixedInterestsResponse'
            }
        };
    }
}
