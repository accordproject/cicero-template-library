...
import { ITemplateModel, IVolumeDiscountRequest } from './generated/org.accordproject.volumediscountolist@0.3.0';
...
describe('VolumeDiscountOListLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.volumediscountolist@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            rates: [
                { $class: 'org.accordproject.volumediscountolist@0.3.0.RateRange', volumeAbove: 0, volumeUpTo: 1000000, rate: 3.0 },
                { $class: 'org.accordproject.volumediscountolist@0.3.0.RateRange', volumeAbove: 1000000, volumeUpTo: 10000000, rate: 2.9 },
                { $class: 'org.accordproject.volumediscountolist@0.3.0.RateRange', volumeAbove: 10000000, volumeUpTo: Infinity, rate: 2.8 },
            ],
        };
    });
    ...
    describe('trigger', () => {
        it('should return the correct rate for a given volume', async () => {
            const request: IVolumeDiscountRequest = {
                $class: 'org.accordproject.volumediscountolist@0.3.0.VolumeDiscountRequest',
                $timestamp: new Date(),
