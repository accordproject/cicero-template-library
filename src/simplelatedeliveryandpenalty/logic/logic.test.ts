...
import { ITemplateModel, ISimpleLateDeliveryAndPenaltyRequest } from './generated/org.accordproject.simplelatedeliveryandpenalty@0.3.0';
...
describe('SimpleLateDeliveryAndPenaltyLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.simplelatedeliveryandpenalty@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            buyer: 'Alice',
            seller: 'Bob',
    ...
    describe('trigger', () => {
        it('should calculate penalty based on current time', async () => {
            ...
            const request: ISimpleLateDeliveryAndPenaltyRequest = {
                $class: 'org.accordproject.simplelatedeliveryandpenalty@0.3.0.SimpleLateDeliveryAndPenaltyRequest',
                $timestamp: new Date(),
