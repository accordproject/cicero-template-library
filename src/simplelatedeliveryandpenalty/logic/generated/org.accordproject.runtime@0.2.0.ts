...
} from './org.accordproject.simplelatedeliveryandpenalty@0.2.0';
...
export type RequestUnion = ISimpleLateDeliveryAndPenaltyRequest;

export interface IResponse extends ITransaction {
}

export type ResponseUnion = ISimpleLateDeliveryAndPenaltyResponse;
