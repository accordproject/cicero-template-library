...
import { ITemplateModel, IVolumeDiscountRequest } from './generated/org.accordproject.volumediscount@0.2.0';
...
describe('VolumeDiscountLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.volumediscount@0.2.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            firstVolume: 1000000,
