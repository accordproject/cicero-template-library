...
import { ITemplateModel, IVolumeDiscountRequest } from './generated/org.accordproject.volumediscount@0.3.0';
...
describe('VolumeDiscountLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.volumediscount@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            firstVolume: 1000000,
    ...
    describe('trigger', () => {
        it('should return firstRate for volume below firstVolume', async () => {
            const request: IVolumeDiscountRequest = {
                $class: 'org.accordproject.volumediscount@0.3.0.VolumeDiscountRequest',
                $timestamp: new Date(),
