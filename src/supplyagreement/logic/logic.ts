...
class SupplyAgreementLogic extends TemplateLogic<ITemplateModel, IAgreementState> {
    ...
    async trigger(
        ...
        if (requestClass === 'org.accordproject.supplyagreement@0.2.0.ForecastRequest') {
            return this.demandForecast(data, request as IForecastRequest, state);
        } else if (requestClass === 'org.accordproject.supplyagreement@0.2.0.PurchaseRequest') {
            return this.purchase(data, request as IPurchaseRequest, state);
        } else if (requestClass === 'org.accordproject.supplyagreement@0.2.0.DeliveryRequest') {
