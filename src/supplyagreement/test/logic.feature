Feature: Supply Agreement
  This describe the expected behavior for the Accord Project's Supply Agreeement
...
"""
  ...
  Scenario: The contract should execute a demand forecast
    Given the state
"""
{
...
Scenario: The contract should execute a purchase order
    Given the state
"""
{
  "$class": "org.accordproject.supplyagreement.AgreementState",
...
Scenario: The contract should execute a delivery
    Given the state
"""
{
    "$class": "org.accordproject.supplyagreement.AgreementState",
