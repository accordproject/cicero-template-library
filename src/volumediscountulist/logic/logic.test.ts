...
import { ITemplateModel, IVolumeDiscountRequest } from './generated/org.accordproject.volumediscountulist@0.2.0';
...
describe('VolumeDiscountUListLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.volumediscountulist@0.2.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            rates: [
                { $class: 'org.accordproject.volumediscountulist@0.2.0.RateRange', volumeAbove: 0, volumeUpTo: 1000000, rate: 3.0 },
                { $class: 'org.accordproject.volumediscountulist@0.2.0.RateRange', volumeAbove: 1000000, volumeUpTo: 10000000, rate: 2.9 },
                { $class: 'org.accordproject.volumediscountulist@0.2.0.RateRange', volumeAbove: 10000000, volumeUpTo: Infinity, rate: 2.8 },
            ],
        };
    });
