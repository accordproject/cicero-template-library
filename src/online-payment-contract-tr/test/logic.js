...
describe('Logic', () => {
    ...
    describe('#OnlinePaymentTr', async function() {

        it('should say whether payment is valid', async function() {
            const request = {};
            request.$class = 'org.accordtr.onlinepayment.MyRequest';
            request.input = 'Payment Valid';
            const state = {};
            ...
            result.response.output.should.equal('Payment Valid');
        });
    });
});
