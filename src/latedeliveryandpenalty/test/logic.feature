...
[
    {
      ...
      "description": "Steve should pay penalty amount to Dan",
      "promisor": "resource:org.accordproject.cicero.contract.AccordParty#Steve",
      "promisee": "resource:org.accordproject.cicero.contract.AccordParty#Dan",
      "eventId": "valid"
    }
]
"""
