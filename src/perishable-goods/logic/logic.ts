import {
    ...
    ITemplateModel,
    ISensorReading,
} from "./generated/org.accordproject.perishablegoods@0.3.0";
...
class PerishableGoodsLogic extends TemplateLogic<ITemplateModel, IPerishableGoodsState> {
    ...
    async init(data: ITemplateModel): Promise<InitResponse<IPerishableGoodsState>> {
        return {
            state: {
                $class: "org.accordproject.perishablegoods@0.3.0.PerishableGoodsState",
    ...
    async trigger(
        ...
        if (now >= dueDate) {
            ...
            const lateResult: IPriceCalculation = {
                $class: "org.accordproject.perishablegoods@0.3.0.PriceCalculation",
        ...
        const event: IPerishableGoodsPaymentEvent = {
            $class: "org.accordproject.perishablegoods@0.3.0.PerishableGoodsPaymentEvent",
            $timestamp: new Date(),
            totalPrice,
            currencyCode: currency,
