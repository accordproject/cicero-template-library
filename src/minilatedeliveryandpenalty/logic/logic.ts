import { ITemplateModel, ILateRequest, ILateResponse } from './generated/org.accordproject.minilatedeliveryandpenalty@0.3.0';
...
class MiniLateDeliveryAndPenaltyLogic extends TemplateLogic<ITemplateModel> {
    async trigger(data: ITemplateModel, request: ILateRequest): Promise<MiniLateDeliveryResponse> {
        ...
        return {
            result: {
                $class: 'org.accordproject.minilatedeliveryandpenalty@0.3.0.LateResponse',
                $timestamp: new Date(),
                penalty,
                buyerMayTerminate,
            },
