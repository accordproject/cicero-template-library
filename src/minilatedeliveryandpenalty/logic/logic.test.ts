...
import { ITemplateModel, ILateRequest } from './generated/org.accordproject.minilatedeliveryandpenalty@0.3.0';
...
describe('MiniLateDeliveryAndPenaltyLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.minilatedeliveryandpenalty@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            buyer: 'Alice',
            seller: 'Bob',
    ...
    describe('trigger', () => {
        it('should calculate penalty for late delivery', async () => {
            ...
            const request: ILateRequest = {
                $class: 'org.accordproject.minilatedeliveryandpenalty@0.3.0.LateRequest',
                $timestamp: new Date(),
