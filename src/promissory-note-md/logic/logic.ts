import { IPayment, IResult, ITemplateModel } from "./generated/org.accordproject.promissorynotemd@0.3.0";
    ...
    async trigger(data: ITemplateModel, request: IPayment): Promise<PromissoryNoteMdResponse> {
        ...
        return {
            result: {
                ...
                $timestamp: new Date(),
                $class: 'org.accordproject.promissorynotemd@0.3.0.Result'
            }
        };
    }
}

export default PromissoryNoteMdLogic;
