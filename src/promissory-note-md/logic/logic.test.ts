...
import { ITemplateModel, IPayment } from './generated/org.accordproject.promissorynotemd@0.3.0';
...
describe('PromissoryNoteMdLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.promissorynotemd@0.3.0.TemplateModel',
            $identifier: 'test-id',
            clauseId: 'test-id',
            amount: 1000.0,
    ...
    describe('trigger', () => {
        it('should compute outstanding balance with compound interest', async () => {
            const request: IPayment = {
                $class: 'org.accordproject.promissorynotemd@0.3.0.Payment',
                $timestamp: new Date(),
                amountPaid: 100.0
            };
            ...
            expect(result.result).toHaveProperty('$class', 'org.accordproject.promissorynotemd@0.3.0.Result');
