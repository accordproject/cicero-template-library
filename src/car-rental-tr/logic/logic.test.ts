...
import { ITemplateModel, IPaymentRequest, IPaymentClause } from './generated/org.accordproject.carrentaltr@0.3.0';
...
describe('CarRentalLogic', () => {
    ...
    beforeEach(() => {
        ...
        const paymentClause: IPaymentClause = {
            $class: 'org.accordproject.carrentaltr@0.3.0.PaymentClause',
        ...
        model = {
            $class: 'org.accordproject.carrentaltr@0.3.0.TemplateModel',
    ...
    describe('trigger', () => {
        it('should return the payment amount from the payment clause', async () => {
            const request: IPaymentRequest = {
                $class: 'org.accordproject.carrentaltr@0.3.0.PaymentRequest',
                $timestamp: new Date()
            };
            ...
            expect(result.result.$class).toBe('org.accordproject.carrentaltr@0.3.0.PayOut');
