...
describe('Logic', () => {
    ...
    describe('#RentalPaymentTr', async function() {

        it('should produce correct payout for car rental', async function() {
            const request = {};
            request.$class = 'org.accordtr.carrental.PaymentRequest';
            const state = {};
            ...
            result.response.amount.doubleValue.should.equal(217.99);
            result.response.amount.currencyCode.should.equal("USD");
        });
    });
});
