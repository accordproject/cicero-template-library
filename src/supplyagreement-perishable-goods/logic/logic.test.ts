...
describe('SupplyAgreementPerishableGoodsLogic', () => {
    ...
    beforeEach(() => {
        ...
        model = {
            $class: 'org.accordproject.supplyagreementperishablegoods@0.2.0.TemplateModel',
    ...
    const makeRequest = (unitCount: number, centigrade: number, humidity: number): IShipmentReceived => ({
        $class: 'org.accordproject.supplyagreementperishablegoods@0.2.0.ShipmentReceived',
        $identifier: 'req-1',
        $timestamp: new Date(),
        unitCount,
        shipment: {
            $class: 'org.accordproject.supplyagreementperishablegoods@0.2.0.Shipment',
            shipmentId: 'SHIP_001',
            status: 'IN_TRANSIT',
            sensorReadings: [
                {
                    $class: 'org.accordproject.supplyagreementperishablegoods@0.2.0.SensorReading',
                    centigrade,
                    humidity,
                }
            ],
